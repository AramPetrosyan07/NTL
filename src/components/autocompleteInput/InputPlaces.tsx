...
const InputPlaces: React.FC<IInputPlaces> = ({
  cbSuccess,
  type,
  disabled = false,
            ...
            <input
              {...getInputProps({
                ...
                className: pathname.includes("changeitems")
                  ...
                  : "p-4 block w-full rounded-md border-[1px] border-slate-400 py-1.5 text-gray-900  ring-0 focus:ring-0 placeholder:text-gray-400   sm:text-sm sm:leading-6 bg-[#f1f5f9] dark:bg-black bg-white text-black dark:text-[#f1f5f9]",
              })}
            />
          </div>
          <div
